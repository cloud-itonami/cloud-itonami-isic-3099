(ns otmfg.phase
  "Phase 0->3 staged rollout for the other-transport-equipment
  ...
  consequence (an assembly-line maintenance window means production
  downtime, and the equipment ends up actually touched); it is always
  a human plant supervisor's call. `otmfg.governor`'s
...
(defn verdict->disposition
  "Map an Other Transport Equipment Plant Operations Governor verdict
