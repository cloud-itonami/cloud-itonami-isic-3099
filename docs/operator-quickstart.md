# Operator Quickstart — Manufacture of other transport equipment n.e.c.

Shortest path from clone to a verified local dry-run for **ISIC 3099** (`cloud-itonami-isic-3099`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-3099.git
cd cloud-itonami-isic-3099
```
...
- Blueprint governor key: `other-transport-equipment-plant-operations-governor`
- Likely source path: `otmfg.governor.cljc`
